      ...
      <div className="glass rounded-xl overflow-hidden transition-all hover:glow-cyan-sm">
        ...
        <div className="relative aspect-square overflow-hidden bg-muted">
          ...
          <button
            ...
            className={`absolute top-2 right-2 md:top-3 md:right-3 w-8 h-8 rounded-full glass flex items-center justify-center transition-all ${
          ...
          <div className="absolute inset-x-0 bottom-0 translate-y-0 md:translate-y-full md:group-hover:translate-y-0 transition-transform duration-300">
            <button
              ...
              className="w-full gradient-cyan text-primary-foreground py-2.5 md:py-3 flex items-center justify-center gap-2 font-semibold text-xs md:text-sm"
            >
        ...
        <div className="p-3 md:p-4">
          ...
          <h3 className="font-display text-sm md:text-base font-semibold line-clamp-1 mb-1">{product.name}</h3>
